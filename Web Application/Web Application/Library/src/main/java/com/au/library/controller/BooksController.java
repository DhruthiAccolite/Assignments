...
//		return books;
	...
	@RequestMapping(value="/checkout/{bookId}/get",method=RequestMethod.GET,produces="application/json")
	public List<Book> checkout(@PathVariable(value="bookId") String bookId){
		return bookDAO.checkout(bookId);
	}
	}
